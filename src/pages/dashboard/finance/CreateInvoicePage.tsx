...
export function CreateInvoicePage() {
    ...
    const isPurchaseInvoice = invoiceType === 'purchase' || invoiceType === 'purchase_return';

    const isSalesInvoice = invoiceType === 'sales' || invoiceType === 'sales_return';
    ...
    }, [isPurchaseInvoice, isSalesInvoice, jobOrderId]);
        ...
        mutationFn: async () => {
            ...
            const { data: invoice, error: invoiceError } = await supabase
                ...
                .insert({
                    ...
                    customer_id: isSalesInvoice ? (customerId || null) : null,

                    supplier_id: isPurchaseInvoice ? (supplierId || null) : null,
                                ...
                                <Table>
                                    ...
                                    <TableHeader>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableHead className="w-[220px]">المنتج</TableHead>

                                            <TableHead className="w-[240px]">الوصف</TableHead>
